        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitedProviderName = table.Column<string>(nullable: true),
                    LimitedIpRange = table.Column<string>(nullable: true),
                    LimitedCountry = table.Column<string>(nullable: true),
                    NoteOfTheDay = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
